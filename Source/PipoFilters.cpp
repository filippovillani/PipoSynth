...
double pipoFilter::LPF2ord(double input, float cutoff, float Q) {
    // forward delay line
    inputs[2] = inputs[1];
    inputs[1] = inputs[0];
    inputs[0] = input;
...
double pipoFilter::HPF2ord(double input, float cutoff, float Q) {
    // forward delay line
    inputs[2] = inputs[1];
    inputs[1] = inputs[0];
    inputs[0] = input;
...
double pipoFilter::BPF2ord(double input, float cutoff, float Q) {
    // forward delay line
    inputs[2] = inputs[1];
    inputs[1] = inputs[0];
    inputs[0] = input;
